...
[{
    ...
    "regex": "Ala(bama|\\.) ?Code ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<title>\\d+[A-Z]?)-(?<chapter>\\d+[A-Z]?)-(?<section>\\d+(\\.\\d+)?)(?<subsection>(\\(\\w+\\))+)?",
    ...
    "regex": "Ariz(ona|\\.)( ?Rev(ised|\\.))? ?Stat(utes?|s?\\.)( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<title>\\d+(\\.\\d+)?[A-Z]?)-(?<section>\\d+(\\.\\d+)?[A-Z]?)(?<subsection>(\\(\\w+\\))+)?",
    ...
    "regex": "(Cal(ifornia|\\.)|CAL?) ?(?<code>[BCDEFGHILMPRSUVW].{2,40}?)( Code,?( Ann(otated|\\.),?)?)? ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.\\-]*\\w|\\d))(?<subsection>(\\(\\w+\\))+)?",
    ...
    "regex": "Conn(ecticut|\\.) ?Gen(eral|\\.) ?Stat(utes?|s?\\.)( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<section>(\\d[a-z\\-]*\\w|\\d+))(?<subsection>(\\(\\w+\\))+)?",
    ...
    "regex": "(Florida Statutes( Annotated)?|Fla\\. ?Stat\\.( ?Ann\\.)?),? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>\\d+[A-Z]?)\\.(?<section>\\d+)(?<subsection>(\\(\\w+\\))+)?(,? \\((?<year>\\d{4})\\))?",
    ...
    "name": "Indiana Code",
    "regex": "Ind(iana|\\.) ?Code( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<title>\\d+)-(?<article>\\d+(\\.\\d+)?)-(?<chapter>\\d+(\\.\\d+)?)-(?<section>\\d+(\\.\\d+)?)(,? \\((?<year>\\d{4})\\))?",
    ...
    "regex": "(K(entucky|y\\.)( ?Rev(ised|\\.))? ?Stat(utes?|s?\\.)|KRS) ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>(\\d[\\d.]*\\w|\\d))\\.(?<section>\\d+)(?<subsection>(\\(\\w+\\))+)?",
    ...
    "regex": "L(ouisiana|a\\.) ?(?<code>Civ(il|\\.) ?Code|Code( of)? ((Civ(il|\\.)|Crim(inal|\\.)) ?Proc(edure|\\.)|Evid(ence|\\.))|Child(ren'?s|\\.) ?Code)( Ann(otated|\\.))?,?( [Aa]rt(icle|\\.))? (?<article>\\d+)(?<subsection>(\\(\\w+\\))+)?",
    ...
    "name": "Maryland Code",
    "regex": "M(aryland|d\\.) ?Code( Ann(otated|\\.))?,? (?<article>(Ac|Al|[BCEFHILNPRST]).{4,38}?) ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<title>\\d+[A-Z]?)[-–](?<section>[\\dA-Z\\-–.]*[\\dA-Z])(?<subsection>(\\(\\w+\\))+)?",
    "URL": ["http://mgaleg.maryland.gov/mgawebsite/Laws/StatuteText?article={article_code}&section={title}-{section}"],
    "mutations": [{
        "token": "section",
        "splitter": "–",
        "joiner": "-"
    ...
    "regex": "(Mass(achusetts|\\.) ?(Gen(eral|\\.)|Ann(otated|\\.)) ?Laws( Ann(otated|\\.))?|M\\.?G\\.?L\\.?(A\\.?)?|A\\.?L\\.?M\\.?),? [Cc]h(apter|\\.) ?(?<chapter>\\d+[A-Z]?),? ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>\\d+[A-Z]?\\d*([/]\\d+[A-Z]?)?)(?<subsection>(\\(\\w+\\))+)?",
    ...
    "regex": "Mich(igan|\\.) Comp(iled|\\.) Laws( (Serv(ice|\\.)|Ann(otated|\\.)))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>\\d+[A-Z]?)\\.(?<section>\\d+)(?<subsection>(\\(\\w+\\))+)?",
    "URL": ["http://legislature.mi.gov/doc.aspx?mcl-{chapter}-{section}"]
}, {
    "name": "Minnesota Statutes",
    "regex": "Minn(esota|\\.) ?Stat(utes?|s?\\.)( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>\\d+[A-Z]?)\\.(?<section>\\d+)(?<subsection>\\((?<subdivision>\\d\\w*)\\)(\\(\\w+\\))*|(\\(\\w+\\))+)?",
    "URL": ["https://www.revisor.mn.gov/statutes/cite/{chapter}.{section}",
        "#stat.{chapter}.{section}.{subdivision}"
    ]
}, {
    "name": "Missouri Revised Statutes",
    "regex": "((M(issouri|o\\.)( Ann(otated|\\.))? ?Rev(ised|\\.) ?Stat(utes|s?\\.)( Ann(otated|\\.))?|R\\.?S\\.?M[Oo]\\.?)) ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>\\d+[A-Z]?)\\.(?<section>\\d+)(?<subsection>(\\(\\w+\\))+)?",
    ...
    "URL": ["http://njlaw.rutgers.edu/collections/njstats/showsect.php?title={title}&chapter={chapter}&section={section}&actn=getsect"]
}, {
    ...
    "regex": "(North Carolina Gen(eral|\\.) Stat(utes|s?\\.)|N\\.? ?C\\.? ?G\\.? ?S\\.?) ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>\\d+[A-Z]?)[–-](?<section>\\d+(\\.\\d+)?)(?<subsection>(\\(\\w+\\))+)?",
    ...
    "regex": "Ohio Rev(ised|\\.) ?Code( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>\\d+)(\\.(?<section>\\d+)(?<subsection>(\\(\\w+\\))+)?)?",
    "URL": ["https://codes.ohio.gov/orc/{chapter}",
        ".{section}v1"
    ]
}, {
    "name": "Oklahoma Statutes",
    "regex": "Okla(homa|\\.) ?Stat(utes|\\.),? [Tt]it(le|\\.) ?(?<title>\\d+[A-Z]?),? ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.\\-]*\\w|\\d))(?<subsection>(\\(\\w+\\))+)?(,? \\((?<year>\\d{4})\\))?",
    ...
    "regex": "Or(egon|\\.) ?Rev(ised|\\.) ?Stat(utes|s?\\.)( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>\\d+[A-Z]?)\\.(?<section>\\d+)(?<subsection>(\\(\\w+\\))+)?",
    "URL": ["https://www.oregonlaws.org/ors/{chapter}.{section}"]
}, {
    "name": "Pennsylvania Code",
    "regex": "(?<title>\\d+) (Pennsylvania|Pa\\.) ?Code( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>\\d+[A-Z]?)\\.(?<section>\\d+)(?<subsection>(\\(\\w+\\))+)?",
    "URL": ["http://www.pacodeandbulletin.gov/Display/pacode?file=/secure/pacode/data/{lpad}{title}/chapter{chapter}/s{chapter}.{section}.html"],
    "substitutions": [{
        "token": "title",
        "outputToken": "lpad",
        "useRegex": true,
    ...
    "regex": "(South Carolina|S\\.? ?C\\.?) Code( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<title>\\d+[A-Z]?)-(?<chapter>\\d+[A-Z]?)-(?<section>\\d+(\\.\\d+)?)(?<subsection>(\\(\\w+\\))+)?",
    ...
    "name": "Tennessee Code",
    "regex": "Tenn(essee|\\.) ?Code( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<title>\\d+[A-Z]?)-(?<chapter>\\d+[A-Z]?)-(?<section>\\d+(\\.\\d+)?)(?<subsection>(\\(\\w+\\))+)?",
    ...
    "name": "Virginia Code",
    "regex": "V(irginia|a\\.) Code( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<title>\\d+(\\.\\d+)?[A-Z]?)-(?<section>\\d+(\\.\\d+)?[A-Z]?)(?<subsection>(\\(\\w+\\))+)?",
    "URL": ["https://law.lis.virginia.gov/vacode/title{title}/section{title}-{section}"]
}, {
    "name": "Revised Code of Washington",
    "regex": "(Wash(ington|\\.) Rev(ised|\\.) Code( Ann(otated|\\.))?|R\\.?C\\.?W) ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<title>\\d+[A-Za-z]?)\\.(?<chapter>\\d+[A-Za-z]?)\\.(?<section>\\d+[A-Za-z]?)(?<subsection>(\\(\\w+\\))+)?",
    "URL": ["https://app.leg.wa.gov/RCW/default.aspx?cite={title}.{chapter}.{section}"]
}, {
    "name": "Wisconsin Statutes",
    "regex": "Wis(consin|\\.) Stat(utes?|s?\\.)( Ann(otated|\\.))? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>\\d+[A-Z]?)\\.(?<section>\\d+)(?<subsection>(\\(\\w+\\))+)?",
...
Law Search recognizes vaguely Bluebook-style citations to [a couple dozen sources of law](#sources-of-law), most notably [every reporter](https://cite.case.law/) in the Caselaw Access Project, and the whole U.S. Code as published by Cornell.

For case law, citations should follow `VOLUME REPORTER PAGE[, PINCITE]` format. For instance, "338 <span>F.2d 708</span>, 715" will go to [page 715 of *In re Kinsman Transit Co.*](https://cite.case.law/f2d/338/708/). U.S. Code citations should look like `TITLE usc SECTION[SUBSECTION]`; "19 <span>U.S.C. §</span> 158(b)(4)" will go [the secondary boycott ban](https://www.law.cornell.edu/uscode/text/29/158#b_4) and, for convenience's sake, so will "19 <span>usc</span> 158 b 4".

Other kinds of citation mostly match the Bluebook and state style guides. Most sources of law don't support subsections. For more info, see [Sources of Law](#sources-of-law).
...
Some of the regexes are very flexible; for instance, "42 <span>usc</span> 1988 b" is functionally identical to "42 <span>U. S. Code</span> § 1988(b)". Other sources are not as flexible. Court reporter names are relatively strict, because they must match the [Caselaw Access Project](https://cite.case.law/) (though capitalization is ignored). Likewise, the regexes are fairly strict about named chapters of state law. For these, I try to support the long form (e.g. "New York Rural Electric Cooperatives Law") and the common abbreviation (e.g. "NY REL"), but I make no promises. Not to mention, only a few states' laws are even recognized at the moment.
...
- [United States Code](https://regexper.com#%28Title%20%29%3F%28%5Cd%2B%29%20%28U%5C.%3F%7CUnited%29%20%3F%28S%5C.%3F%7CStates%29%20%3F%28C%5C.%3F%7CCode%29%28%20%3F%5BAS%5D%5C.%3F%29%3F%20%28%28%26sect%3B%7C%26%23167%7C%C2%A7%29%7B1%2C2%7D%7CSect%3F%28ions%3F%7Cs%3F%5C.%29%29%3F%20%3F%28%28%5Cd%5B%5Cd.%5C-%5D%2A%5Cw%7C%5Cd%29%29%28%28%5C%28%5Cw%2B%5C%29%29%2B%29%3F)
- [United States Constitution](https://regexper.com#%28U%5C.%3F%20%3FS%5C.%3F%20%3F%7CUnited%20States%29%20Const%28itution%7C%5C.%29%2C%3F%20%28%5BAa%5Drt%28icle%7C%5C.%29%20%28%5B%5CdIViv%5D%7B1%2C3%7D%29%7C%5BAa%5Dm%28endment%7C%28end%7Cdt%3F%29%3F%5C.%29%20%28%5B%5CdXIVxiv%5D%7B1%2C3%7D%29%29%28%28%2C%3F%20%28%28%26sect%3B%7C%26%23167%7C%C2%A7%29%7B1%2C2%7D%7CSect%3F%28ions%3F%7Cs%3F%5C.%29%29%20%3F%28%5Cd%2B%29%29%28%28%2C%3F%20%28cl%28ause%7C%5C.%29%20%3F%28%5B0-9%5D%2B%29%29%29%29%3F%29%3F)
- [U.S. Public Laws](https://regexper.com#Pub%28%5C.%3F%7Clic%29%20%3FL%28%5C.%3F%7Caw%29%20%3F%28No%5C.%3F%29%3F%20%3F%28%5Cd%2B%29%5B%E2%80%93-%5D%28%5Cd%2B%29)
- [U.S. Statutes at Large](https://regexper.com#%28%5Cd%2B%29%20Stat%5C.%3F%20%28%5Cd%2B%29%28%5B%E2%80%93-%5D%5Cd%2B%29%3F)
...
- [Code of Federal Regulations](https://regexper.com#%28Title%20%29%3F%28%5Cd%2B%29%20%28C%5C.%3F%20%3FF%5C.%3F%20%3FR%5C.%3F%7CCode%20of%20Federal%20Regulations%29%28%20%5BPp%5Darts%3F%7C%20%5BPp%5Dts%3F%5C.%29%3F%20%28%28%26sect%3B%7C%26%23167%7C%C2%A7%29%7B1%2C2%7D%7CSect%3F%28ions%3F%7Cs%3F%5C.%29%29%3F%20%3F%28%28%5Cd%5B%5Cd.%5C-%5D%2A%5Cw%7C%5Cd%29%29%28%28%5C%28%5Cw%2B%5C%29%29%2B%29%3F)
...
- [Immigration and Nationality Act](https://regexper.com#%28Immigration%20%28%5BAa%5Dnd%7C%26%29%20Nationality%20Act%7CI%5C.%3F%20%3FN%5C.%3F%20%3FA%5C.%3F%29%20%28%28%26sect%3B%7C%26%23167%7C%C2%A7%29%7B1%2C2%7D%7CSect%3F%28ions%3F%7Cs%3F%5C.%29%29%3F%20%3F%28%28%5Cd%5B%5Cd.%5C-%5D%2A%5Cw%7C%5Cd%29%29%28%28%5C%28%5Cw%2B%5C%29%29%2B%29%3F)
- [Internal Revenue Code](https://regexper.com#%28Internal%20Revenue%20Code%7CI%5C.%3F%20%3FR%5C.%3F%20%3FC%5C.%3F%29%20%28%28%26sect%3B%7C%26%23167%7C%C2%A7%29%7B1%2C2%7D%7CSect%3F%28ions%3F%7Cs%3F%5C.%29%29%3F%20%3F%28%28%5Cd%5B%5Cd.%5C-%5D%2A%5Cw%7C%5Cd%29%29%28%28%5C%28%5Cw%2B%5C%29%29%2B%29%3F)
- [Treasury Regulations](https://regexper.com#Treas%28ury%7C%5C.%3F%29%20%3FReg%28ulations%3F%7C%5C.%3F%29%20%28%28%26sect%3B%7C%26%23167%7C%C2%A7%29%7B1%2C2%7D%7CSect%3F%28ions%3F%7Cs%3F%5C.%29%29%3F%20%3F%28%28%5Cd%5B%5Cd.%5C-%5D%2A%5Cw%7C%5Cd%29%29%28%28%5C%28%5Cw%2B%5C%29%29%2B%29%3F)