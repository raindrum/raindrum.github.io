...
[{
    ...
    "regex": "(Title )?(?<title>\\d+) (U\\.?|United) ?(S\\.?|States) ?(C\\.?|Code)( ?[AS]\\.?)? ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    ...
    "regex": "(Title )?(?<title>\\d+) (C\\.? ?F\\.? ?R\\.?|Code of Federal Regulations)( [Pp]arts?| [Pp]ts?\\.)? ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    ...
    "regex": "(F\\.? ?R\\.? ?C\\.? ?P\\.?|Fed\\.? ?R(\\.?|ule) ?Civ\\.? ?Pr?o?c?\\.?|Federal Rules? of Civil Procedure) ?(Rule )?(?<rule>\\d+[a-z]?)( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    ...
    "regex": "(F\\.? ?R\\.? ?Cr\\.? ?P\\.?|Fed\\.? ?R(\\.?|ule) ?Crim\\.? ?Pr?o?c?\\.?|Federal Rules? of Criminal Procedure) ?(Rule )?(?<rule>\\d+[a-z]?)( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    ...
    "regex": "(Immigration ([Aa]nd|&) Nationality Act|I\\.? ?N\\.? ?A\\.?) ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    "URL": ["https://www.law.cornell.edu/uscode/text/{title}/{section}",
        "#{subsec}"
    ],
    "defaults": {
    ...
    "regex": "(Internal Revenue Code|I\\.? ?R\\.? ?C\\.?) ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    "URL": ["https://www.law.cornell.edu/uscode/text/{title}/{section}",
        "#{subsec}"
    ],
    "defaults": {
    ...
    "regex": "Treas(ury|\\.?) ?Reg(ulations?|\\.?) ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    "URL": ["https://www.law.cornell.edu/cfr/text/{title}/{section}",
        "#{subsec}"
    ],
    "defaults": {
    ...
    "regex": "(Natioanal Labor Relations Act|N\\.? ?L\\.? ?R\\.? ?A\\.?) ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    "URL": ["https://www.law.cornell.edu/uscode/text/{title}/{section}",
        "#{subsec}"
    ],
    "defaults": {
    ...
    "regex": "(Endangered Species Act|E\\.? ?S\\.? ?A\\.?) ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    "URL": ["https://www.law.cornell.edu/uscode/text/{title}/{section}",
        "#{subsec}"
    ],
    "defaults": {
    ...
    "name": "Clean Air Act",
    "regex": "C\\.? ?A\\.? ?A\\.? ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    "URL": ["https://www.law.cornell.edu/uscode/text/{title}/{section}",
        "#{subsec}"
    ],
    "defaults": {
    ...
    "regex": "(Clean Water Act|C\\.? ?W\\.? ?A\\.?) ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    "URL": ["https://www.law.cornell.edu/uscode/text/{title}/{section}",
        "#{subsec}"
    ],
    "defaults": {
    ...
    "regex": "(Fair Housing Act|F\\.? ?h\\.? ?A\\.?) ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    "URL": ["https://www.law.cornell.edu/uscode/text/{title}/{section}",
        "#{subsec}"
    ],
    "defaults": {
    ...
    "regex": "(Americans [Ww]ith Disabilities Act|A\\.? ?D\\.? ?A\\.?) ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    "URL": ["https://www.law.cornell.edu/uscode/text/{title}/{section}",
        "#{subsec}"
    ],
    "defaults": {
    ...
    "regex": "(Uniform Commercial Code|U\\.? ?C\\.? ?C\\.?)( ?§)? (?<article>\\d[a-z]?)\\W+(?<section>\\d+)( ?(?<subsec>(\\(\\w+\\))+|((\\w{1,5}) ?)+))?",
    ...
    "regex": "((CAL|Cal)\\.?|California) (?<code>.{2,40}?)\\.?( Code)? ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+))?",
    ...
    "regex": "(D\\.? ?G\\.? ?C\\.? ?L\\.?|Del(aware|\\.) ?Gen(eral|\\.) ?Corp(orations?|s?\\.) ?L(aw|\\.)) ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+))?",
    "URL": ["https://delcode.delaware.gov/title8/c001/sc{subchap}/index.shtml#{section}"],
    "substitutions": [{
        "token": "section",
        "outputToken": "subchap",
        "useRegex": true,
    ...
    "regex": "(New York|N\\.? ?Y\\.?) (?<chapter>.{2,40}?)\\.?( Law)? ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))( ?(?<subsec>(\\(\\w+\\))+))?",
...
- [California Codes](https://regexper.com#%28%28CAL%7CCal%29%5C.%3F%7CCalifornia%29%20%28.%7B2%2C40%7D%3F%29%5C.%3F%28%20Code%29%3F%20%28%28%26sect%3B%7C%26%23167%7C%C2%A7%29%7B1%2C2%7D%7CSect%3F%28ions%3F%7Cs%3F%5C.%29%29%3F%20%3F%28%28%5Cd%5B%5Cd.-%5D%2A%5Cw%7C%5Cd%29%29%28%20%3F%28%28%5C%28%5Cw%2B%5C%29%29%2B%29%29%3F)
