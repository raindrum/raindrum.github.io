...
[{
    ...
    "regex": "(Cal(ifornia|\\.)|CAL?) (?<code>[BCDEFGHILMPRSUVW].{2,40}?)\\.?( Code,?)? ((&sect;|&#167|§){1,2}|Sect?(ions?|s?\\.))? ?(?<section>(\\d[\\d.-]*\\w|\\d))(?<subsection>(\\(\\w+\\))+)?",
    ...
    "name": "Texas Codes",
    "regex": "(Tex(as|\\.)|TX) (?<code>.{2,40}?)\\.?( Code( Ann(otated|\\.))?)? ?(Sections?|(&sect;|&#167|§){1,2})? ?(?<chapter>\\d+)\\.(?<section>\\d+)(?<subsection>(\\(\\w+\\))+)?",
    ...
    "substitutions": [{
        ...
        "index": {
            "Agriculture|AGC?": "AG",
            "Alc(oholic|\\.) Bev(erage|\\.)|ABC?": "AB",
            "Aux(iliary|\\.) Water Laws|A?WL": "WL",
            "Bus(iness|\\.) (and|&) Commerce|B&C|BCC?": "BC",
            "Bus(iness|\\.) Org(anizations|s)|BOC?": "BO",
            "Civ(il|\\.) Prac(tice|\\.) (and|&) Remedies|CPR?C?": "CP",
            ...
            "Fam(ily)?|FAC?|FAM": "FA",
            "Fin(ance)?|FIC?|FIN": "FI",
            "Gov(ernment|\\.)|GO?VC?": "GV",
            "Health (and|&) Safety|H&?SC?": "HS",
            "Human Res(ources|\\.)|HRC?": "HR",
            "Ins(urance)?|INC?": "IN",
            "Labor|LA": "LA",
            "Local Gov(ernment|\\.)|LGC?": "LG",
            "Natural Res(ources|\\.)|NRC?": "NR",
            "Occupations|OC": "OC",
            "Parks (and|&) Wildlife|PWC?": "PW",
            "Penal|PEN?|PC": "PE",
            "Property|PR|PC": "PR",
            "Special Dist(rict|\\.) Local Laws|SDC?": "SD",
            "Tax|TX?C": "TX",
            "Transp(ortation)?|TNC?": "TN",
            "Utilities|UTC?": "UT",
            "Water|WAC?": "WA",
...
function handleSubstitutions(match) {
  ...
  for (var s in schema.substitutions) {
    ...
    if (sub['useRegex']) {
      ...
      if (newKey === undefined) { newKey = sub['index'][keys[sub['token']].toUpperCase()]; }
      if (newKey === undefined) { newKey = sub['index'][keys[sub['token']].toLowerCase()]; }
    }
    if (newKey === undefined) {
...
- [California Codes](https://regexper.com#%28Cal%28ifornia%7C%5C.%29%7CCAL%3F%29%20%28%5BBCDEFGHILMPRSUVW%5D.%7B2%2C40%7D%3F%29%5C.%3F%28%20Code%2C%3F%29%3F%20%28%28%26sect%3B%7C%26%23167%7C%C2%A7%29%7B1%2C2%7D%7CSect%3F%28ions%3F%7Cs%3F%5C.%29%29%3F%20%3F%28%28%5Cd%5B%5Cd.-%5D%2A%5Cw%7C%5Cd%29%29%28%28%5C%28%5Cw%2B%5C%29%29%2B%29%3F)
...
- [Texas Codes](https://regexper.com#%28Tex%28as%7C%5C.%29%7CTX%29%20%28.%7B2%2C40%7D%3F%29%5C.%3F%28%20Code%28%20Ann%28otated%7C%5C.%29%29%3F%29%3F%20%3F%28Sections%3F%7C%28%26sect%3B%7C%26%23167%7C%C2%A7%29%7B1%2C2%7D%29%3F%20%3F%28%5Cd%2B%29%5C.%28%5Cd%2B%29%28%28%5C%28%5Cw%2B%5C%29%29%2B%29%3F)
- [Consolidated Laws of New York](https://regexper.com#%28New%20York%7CN%5C.%3F%20%3FY%5C.%3F%29%20%3F%28.%7B2%2C40%7D%3F%29%5C.%3F%28%20Law%29%3F%20%28%28%26sect%3B%7C%26%23167%7C%C2%A7%29%7B1%2C2%7D%7CSect%3F%28ions%3F%7Cs%3F%5C.%29%29%3F%20%3F%28%28%5Cd%5B%5Cd.-%5D%2A%5Cw%7C%5Cd%29%29%28%28%5C%28%5Cw%2B%5C%29%29%2B%29%3F)
